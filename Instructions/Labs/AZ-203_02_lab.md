...
1. In the Azure portal, create a new **function app** with the following details:
    ...
    - **New resource group**: ManagedResourceGroup
...
1.  In the **Resource groups** blade, locate and select the **ManagedResourceGroup** resource group that you created earlier in this lab.

1.  In the **ManagedResourceGroup** blade, select the **imgfunc\*** function app that you created earlier in this lab.
